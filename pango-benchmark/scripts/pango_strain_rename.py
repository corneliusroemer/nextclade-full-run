...
def format(metadata_strainnames, pango_in, pango_designations, pango_designated_strains):
    ...
    pango_des["canonical"] = pango_des.taxon.apply(lambda x: alpha_digits_regex.sub("", x.upper()))
    ...
    pango_des.to_csv(pango_designated_strains, columns=["strain"], header=False, index=False)
